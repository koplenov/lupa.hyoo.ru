...
declare namespace $ {
	...
	type $mol_svg_path__geometry__SAKKGKKB = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__FNHH3XOE = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__JMAL0VMX = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__FHD2F6LI = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__VNRPMY97 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__RSVWVRNA = $mol_type_enforce<
		string
		,
