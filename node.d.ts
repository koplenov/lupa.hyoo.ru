...
declare namespace $ {
	...
	type $mol_svg_path__geometry__1VESK04L = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__SBAFBN0F = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__O5ACKCL7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__QZK9XMRF = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__PBY7JRHD = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__MRJ8O3ZB = $mol_type_enforce<
		string
		,
