...
declare namespace $ {
	...
	type $mol_svg_path__geometry__EO9M097U = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__G3SN70WN = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__NPQ3VOFB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__SRO3OO4E = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__KJ2B3PJM = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__WFQL9HDL = $mol_type_enforce<
		string
		,
