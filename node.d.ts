...
declare namespace $ {
	...
	type $mol_svg_path__geometry__6Y8SBN6T = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__HFOOHSAS = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__0RLVBSWH = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__5XOCLPK0 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__H90IF5WZ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__WK27KTPR = $mol_type_enforce<
		string
		,
