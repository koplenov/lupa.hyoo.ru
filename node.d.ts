...
declare namespace $ {
	...
	type $mol_svg_path__geometry__Q7TJPZ6Y = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__D0GWFELC = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__2VEATOMN = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__AR6BJRP2 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__HDWGBQBR = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__B1WYJERR = $mol_type_enforce<
		string
		,
