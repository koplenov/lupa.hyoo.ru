...
declare namespace $ {
	...
	type $mol_svg_path__geometry__3WWCTA0X = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__PDZARM5O = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__8YUYHZWB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__85DPDRRV = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__7NNFRJ19 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__E2IWAAHM = $mol_type_enforce<
		string
		,
