...
declare namespace $ {
	...
	type $mol_svg_path__geometry__BVAE1SHC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__4TMJCGCP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__T7R9IC2Z = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__OESMLYL1 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__JZWHAAXB = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__IG7706SE = $mol_type_enforce<
		string
		,
