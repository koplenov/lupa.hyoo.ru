...
declare namespace $ {
	...
	type $mol_svg_path__geometry__C3X3AG3C = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__ZKV3J1HB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__WE1NF65D = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__F8T8PH3V = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__O56QQPLA = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__IN8UMQPE = $mol_type_enforce<
		string
		,
