...
declare namespace $ {
	...
	type $mol_svg_path__geometry__PKG6F5P4 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__4RZ13LRZ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__RLOKX0CO = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__CEB1Q6XO = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__I8Q6DOIY = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__X0289HZZ = $mol_type_enforce<
		string
		,
