...
declare namespace $ {
	...
	type $mol_svg_path__geometry__8P447YNT = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__F0PHJ37Z = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__2MUN51MN = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__RXVOVF6Z = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__S7BTR8T0 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__DD9R5FHF = $mol_type_enforce<
		string
		,
