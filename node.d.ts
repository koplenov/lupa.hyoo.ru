...
declare namespace $ {
	...
	type $mol_svg_path__geometry__Z225H4WQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__LNMX3ZFB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__HBM97KXA = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__Q84844ET = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__4Q1F4KQ3 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__PQGYA7XX = $mol_type_enforce<
		string
		,
