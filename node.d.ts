...
declare namespace $ {
	...
	type $mol_svg_path__geometry__ZMZTQTW0 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__O3KQSCSP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__LR7MY05V = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__GCWWHITC = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__J5V3H1WA = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__P6GBNF3A = $mol_type_enforce<
		string
		,
