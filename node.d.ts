...
declare namespace $ {
	...
	type $mol_svg_path__geometry__DGMJZUVA = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__P7ZTFYSE = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__5ABZWJSH = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__8Z79D58J = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__DAHIO5XA = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__0S5PFSTF = $mol_type_enforce<
		string
		,
