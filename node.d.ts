...
declare namespace $ {
	...
	type $mol_svg_path__geometry__TPWEEOC2 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__47PM51QX = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__NOW7SSNR = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__L8QKV77T = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__C8G93O88 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__09MYU85B = $mol_type_enforce<
		string
		,
