...
declare namespace $ {
	...
	type $mol_svg_path__geometry__K7ZGEL4R = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__C33MA0BV = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__VIFPJFSZ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__CIIEID9S = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__GOBG29SZ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__J7VUOEKQ = $mol_type_enforce<
		string
		,
