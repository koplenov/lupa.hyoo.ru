...
declare namespace $ {
	...
	type $mol_svg_path__geometry__1UMH04DJ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__XXMFA6OM = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__Y1EYM0US = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__VRINOUHN = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__L0ANSYUF = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__JY6VLF6F = $mol_type_enforce<
		string
		,
