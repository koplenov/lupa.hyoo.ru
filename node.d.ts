...
declare namespace $ {
	...
	type $mol_svg_path__geometry__TCM7PYBR = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__N9KHC8F3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__TMHUG0IS = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__RG17S0SU = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__K1UF9KGH = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__GGRK3TYO = $mol_type_enforce<
		string
		,
