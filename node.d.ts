...
declare namespace $ {
	...
	type $mol_svg_path__geometry__8FPUAWMQ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__BPDDR0EK = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__FWYNQBUE = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__POYCQXHD = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__DYFIJNYG = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__WIM9D5WN = $mol_type_enforce<
		string
		,
