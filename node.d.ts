...
declare namespace $ {
	...
	type $mol_svg_path__geometry__I4XX2OUB = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__OVQ6UZ49 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__3T2CQJU3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__UKB98X8L = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__PGD26018 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__GHHVCM3P = $mol_type_enforce<
		string
		,
