...
declare namespace $ {
	...
	type $mol_svg_path__geometry__K76ZF3RC = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__0GG0RRQ6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__5QZELEPP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__OZET0KB5 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__5NLAC0OD = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__X4F1VP6Q = $mol_type_enforce<
		string
		,
