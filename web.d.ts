...
declare namespace $ {
	...
	type $mol_svg_path__geometry__6K2KECYG = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__E6NZ6M5J = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__H5B5Q77C = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__MGHIOU51 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__R7ORO2UT = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__AVQL13AS = $mol_type_enforce<
		string
		,
