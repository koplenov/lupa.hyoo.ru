...
declare namespace $ {
	...
	type $mol_svg_path__geometry__NLWQQBND = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__MC5B3PF9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__2HCPDIRV = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__ZQM1YSXR = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__F6VPHS4C = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__76XO7VRS = $mol_type_enforce<
		string
		,
