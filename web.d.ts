...
declare namespace $ {
	...
	type $mol_svg_path__geometry__57XRBQ3R = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__JMHHZKUP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__O32CJV8Q = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__22NSKJ4B = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__IWQIOH2X = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__O8P5H6AC = $mol_type_enforce<
		string
		,
