...
declare namespace $ {
	...
	type $mol_svg_path__geometry__3KAOLVRT = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__PNMSSNZ6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__B0CCWPIG = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__PRVBCT4A = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__5TR4YRW0 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__FC3ELOLY = $mol_type_enforce<
		string
		,
