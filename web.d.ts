...
declare namespace $ {
	...
	type $mol_svg_path__geometry__OHMGHATJ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__PDPH41O4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__E8PJZCGF = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__149G0QHM = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__VQXP5XMG = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__MRXXSFEB = $mol_type_enforce<
		string
		,
