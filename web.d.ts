...
declare namespace $ {
	...
	type $mol_svg_path__geometry__1BUY7BMZ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__IH841XRK = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__EAOHYEPI = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__A5PNPJC6 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__OQPOHDRU = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__M1G13IYS = $mol_type_enforce<
		string
		,
