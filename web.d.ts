...
declare namespace $ {
	...
	type $mol_svg_path__geometry__3T65UF1Z = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__P68M72SH = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__CA762434 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__F2K1KZ6S = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__GZWLAJRL = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__TPV4799R = $mol_type_enforce<
		string
		,
