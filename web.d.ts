...
declare namespace $ {
	...
	type $mol_svg_path__geometry__LPFFUPJ6 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__BLL8ZTIQ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__X0UCEX1B = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__9K77IUMJ = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__73B0B4IE = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__QKIVC7CZ = $mol_type_enforce<
		string
		,
