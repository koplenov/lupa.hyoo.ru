...
declare namespace $ {
	...
	type $mol_svg_path__geometry__KALFRZRP = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__8IWFGEY9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__VXJ8O5ZN = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__VNEY5X97 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__ZCT2OZBI = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__BETXS6XE = $mol_type_enforce<
		string
		,
