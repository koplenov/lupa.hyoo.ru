...
declare namespace $ {
	...
	type $mol_svg_path__geometry__HSQZZM0O = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__38DM030Q = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__WIS60PID = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__ZEVWJN0M = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__CJGSDIUH = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__S84GKVYM = $mol_type_enforce<
		string
		,
