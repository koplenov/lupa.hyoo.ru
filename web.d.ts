...
declare namespace $ {
	...
	type $mol_svg_path__geometry__0UNT642Y = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__QPEXYJET = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__H87QNILC = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__BVB0X52Y = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__OJYS0O6V = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__ERWYFJ7C = $mol_type_enforce<
		string
		,
