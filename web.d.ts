...
declare namespace $ {
	...
	type $mol_svg_path__geometry__BYLSESUL = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__PCQ0KK3G = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__WCPYTLZ7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__UGODJW9H = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__G717WBJN = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__SRYBRH7L = $mol_type_enforce<
		string
		,
