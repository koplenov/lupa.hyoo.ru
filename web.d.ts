...
declare namespace $ {
	...
	type $mol_svg_path__geometry__DR67F1RZ = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__ESVFM2YS = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__P1GO35GA = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__KP33RQDL = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__N7P027VR = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__SD37CRCY = $mol_type_enforce<
		string
		,
