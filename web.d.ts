...
declare namespace $ {
	...
	type $mol_svg_path__geometry__9JERS0AR = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__YAV9U39C = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__DPK4ZKOA = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__WX0XA2OH = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__Q1ETHAON = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__ZG9VWJ5X = $mol_type_enforce<
		string
		,
