...
declare namespace $ {
	...
	type $mol_svg_path__geometry__JDAO4WOX = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__80SHPXPF = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__373LGJNO = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__YVJO8IGD = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__SV8LB9CD = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__4L6X2ZVU = $mol_type_enforce<
		string
		,
