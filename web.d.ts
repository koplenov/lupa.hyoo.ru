...
declare namespace $ {
	...
	type $mol_svg_path__geometry__2WX17ARK = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__CBWJ62YG = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__NOLTLMBQ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__HWYENF7U = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__JEG9TKHC = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__NN97S1O4 = $mol_type_enforce<
		string
		,
