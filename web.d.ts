...
declare namespace $ {
	...
	type $mol_svg_path__geometry__7EJP09M5 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__U07XWZIV = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__ZJOARQ7X = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__YSVT5DY6 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__N63V6BIX = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__DLVRBC5A = $mol_type_enforce<
		string
		,
