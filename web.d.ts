...
declare namespace $ {
	...
	type $mol_svg_path__geometry__Q699KDI3 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_video_camera__title__VBBRRWAI = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['title'] >
	>
	type $mol_video_camera__facing__W8MAFX6J = $mol_type_enforce<
		string
		,
		ReturnType< $mol_video_camera['facing'] >
	>
	type $mol_video_camera__sharpness__34WIVBAN = $mol_type_enforce<
		number
		,
		ReturnType< $mol_video_camera['sharpness'] >
	>
	type $mol_video_camera__torch__RGBSAXTZ = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_video_camera['torch'] >
	>
	type $mol_link_source__uri__AQSDP61B = $mol_type_enforce<
		string
		,
